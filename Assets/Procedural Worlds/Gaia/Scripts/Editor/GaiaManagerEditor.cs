            ...
            try
            {
                ...
                if (m_editorUtils != null)
                {
                    if (GaiaUtils.CheckIfSceneProfileExists())
                    {
                        ...
                        if (m_settings.m_quickBakeLighting && sceneProfile.m_selectedLightingProfileValuesIndex != -99)
                        {
